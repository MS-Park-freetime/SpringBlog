...
<div class="container">
	<form action="/auth/loginProc" method="POST">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=93d0eb0d50412de328c5fa9fd40f3f4b&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code"><img height="38px" src="/image/kakao_login_button.png"/></a>
	</form>
</div>
